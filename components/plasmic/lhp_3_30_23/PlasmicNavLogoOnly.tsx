...
import sty from "./PlasmicNavLogoOnly.module.css"; // plasmic-import: Vjbbl6nYeyZGaS/css
        ...
        {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
          ...
          >
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__jngmG)} />
            ) : null}
            <div className={classNames(projectcss.all, sty.column__fR7Kr)}>
              <p.PlasmicLink
            ...
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__bKCtn)} />
            ) : null}
          </div>
        ) : null}
      </div>
