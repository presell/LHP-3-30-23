...
import { PlasmicHead } from "@plasmicapp/react-web"; // plasmic-import: AgzOkASoRN1u/codeComponent
...
import sty from "./PlasmicBodyArticle2.module.css"; // plasmic-import: t0aIBfhdPpHEyC/css
...
function PlasmicBodyArticle2__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link___8DjFx)}
        component={Link}
        href={(() => {
          try {
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__awtdq)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__sxMfK)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link___4ZWok)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__u95J)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link___253Vo)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__tqCyU)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
      ...
      {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.column__rz5Ja)}>
              <p.PlasmicLink
                className={classNames(
                  projectcss.all,
                  projectcss.a,
            ...
            <div className={classNames(projectcss.all, sty.column___1VfY)}>
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__je0Po)}
                displayHeight={
                  hasVariant(globalVariants, "screen", "mobileOnly")
                    ? ("70%" as const)
                    : ("80%" as const)
                ...
                loading={"lazy" as const}
                src={{
                  src: "/plasmic/lhp_3_30_23/images/_4F0Afe7D15505Bfe240E785E7Ac88B6Cwebp.webp",
                  fullWidth: 3,
                  fullHeight: 90,
            ...
            <div className={classNames(projectcss.all, sty.column__aMkty)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__gh8J9)}
      ...
      <p.PlasmicLink
        className={classNames(projectcss.all, projectcss.a, sty.link__ad0F2)}
        component={Link}
        href={(() => {
          try {
            return $ctx.fetchDyanamicData.records[0].fields["Step 2 URL"];
