...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: cTSOzRzGXMakC/css

import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: uW9W1UklmtCQHm/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__prE91)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__hk4Zz)}
                role={"img"}
              />
            ),
