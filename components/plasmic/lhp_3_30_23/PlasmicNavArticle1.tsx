...
import sty from "./PlasmicNavArticle1.module.css"; // plasmic-import: cAuqX6OMLfDtrB/css
        ...
        {(hasVariant(globalVariants, "screen", "mobileOnly") ? true : true) ? (
          ...
          >
            {(
              ...
              <div className={classNames(projectcss.all, sty.column__hZxh)}>
                <div
            ...
            <div className={classNames(projectcss.all, sty.column__eHqQ)}>
              <p.PlasmicLink
                className={classNames(
                  projectcss.all,
                  projectcss.a,
            ...
            {(
              ...
              <div className={classNames(projectcss.all, sty.column___4XcFq)}>
                <p.PlasmicLink
                  className={classNames(
                    projectcss.all,
                    projectcss.a,
