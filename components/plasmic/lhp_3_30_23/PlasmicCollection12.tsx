...
import sty from "./PlasmicCollection12.module.css"; // plasmic-import: 9Pza3R-tisl/css
...
function PlasmicCollection12__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__wsLgy)}>
        <div
          className={classNames(
            projectcss.all,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__kPrB7)}>
        <div className={classNames(projectcss.all, sty.freeBox__ope5)}>
          {true ? (
            <p.PlasmicLink
              className={classNames(
                projectcss.all,
            ...
            >
              {(
                ...
                >
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img___3GpOw)}
              ...
              >
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__dlVzQ)}
                  displayHeight={"auto" as const}
                  displayMaxHeight={"none" as const}
                  displayMaxWidth={"100%" as const}
                  displayMinHeight={"0" as const}
      ...
      {true ? (
        <div className={classNames(projectcss.all, sty.freeBox__zjXiK)}>
          <div
          ...
          <div className={classNames(projectcss.all, sty.freeBox__jXs8S)}>
            <div className={classNames(projectcss.all, sty.freeBox__rw61L)}>
              <p.PlasmicImg
            ...
            <div className={classNames(projectcss.all, sty.freeBox__imLxu)}>
              <p.PlasmicImg
            ...
            <div className={classNames(projectcss.all, sty.freeBox___3Calv)}>
              <p.PlasmicImg
            ...
            <div className={classNames(projectcss.all, sty.freeBox__zyTo6)}>
              <p.PlasmicImg
      ...
      >
        <div className={classNames(projectcss.all, sty.columns___4Luae)}>
          <p.PlasmicLink
            className={classNames(
              projectcss.all,
              projectcss.a,
          ...
          >
            <Collection1
              className={classNames("__wab_instance", sty.collection1__kLiMd)}
              slot9={"$56"}
            >
              <p.PlasmicImg
                alt={""}
          ...
          {true ? (
            ...
            >
              <Collection1
                className={classNames("__wab_instance", sty.collection1__zVuSi)}
                slot={"VARIETY PACK"}
                slot9={
                  <div
                    className={classNames(
          ...
          >
            <Collection1
              className={classNames("__wab_instance", sty.collection1__x1HQ)}
              slot={"FUEL"}
            ...
            <Collection1Cta
              className={classNames(
                "__wab_instance",
                sty.collection1Cta__pcnod
              )}
            />
          </p.PlasmicLink>
        </div>
        <div className={classNames(projectcss.all, sty.columns__qPmg)}>
          <p.PlasmicLink
            className={classNames(
              projectcss.all,
              projectcss.a,
          ...
          >
            <Collection1
              className={classNames("__wab_instance", sty.collection1__xy7FY)}
              slot={
                <div
                  className={classNames(
                    projectcss.all,
            ...
            <Collection1Cta
              className={classNames("__wab_instance", sty.collection1Cta__klDK)}
            >
              <div
                className={classNames(
                  projectcss.all,
          ...
          {true ? (
            ...
            >
              <Collection1
                className={classNames("__wab_instance", sty.collection1__gos5G)}
                slot={"MELT"}
          ...
          {true ? (
            ...
            >
              <Collection1
                className={classNames("__wab_instance", sty.collection1__zZ6Ab)}
                slot={"FUEL"}
                slot3={"Energy-Enhancing"}
                slot9={"$20"}
              >
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__afv7M)}
