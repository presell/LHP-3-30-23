...
import sty from "./PlasmicCollection12.module.css"; // plasmic-import: QGBJ8SdBbLTIK2/css
...
function PlasmicCollection12__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__gphZv)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__nRrDb)}
      ...
      <div className={classNames(projectcss.all, sty.freeBox__iULow)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__pVx17)}>
        {p.renderPlasmicSlot({
          defaultContents: "★★★★★ (447)",
          value: args.slot2,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__o35P)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__q08Lc)}>
        {p.renderPlasmicSlot({
