...
import sty from "./PlasmicCollection1.module.css"; // plasmic-import: vA1Wg9x_sh5TE2/css
...
function PlasmicCollection1__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__s5Nwo)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
      ...
      <div className={classNames(projectcss.all, sty.freeBox___7O87O)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__u6N78)}>
        {p.renderPlasmicSlot({
          defaultContents: "★★★★★ (447)",
          value: args.slot2,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__pGazs)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__yBr2Z)}>
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__yWvcL)}>
        {p.renderPlasmicSlot({
      ...
      >
        <div className={classNames(projectcss.all, sty.column__sxLnq)}>
          <div className={classNames(projectcss.all, sty.freeBox__lIa4V)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__blXcg)}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__cYwN4)}>
              {p.renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.column__kBzGq)}>
          <div className={classNames(projectcss.all, sty.freeBox__thfYr)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img___3SVmF)}
                  displayHeight={"auto" as const}
                  displayMaxHeight={"none" as const}
                  displayMaxWidth={"100%" as const}
                  displayMinHeight={"0" as const}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__zw59P)}>
              {p.renderPlasmicSlot({
