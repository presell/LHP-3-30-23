...
import sty from "./PlasmicOffer1.module.css"; // plasmic-import: IfOzLkHETww2DF/css
...
function PlasmicOffer1__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__nGGm)}>
        <div className={classNames(projectcss.all, sty.freeBox__mjgsn)}>
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img___05Akl)}
      ...
      <div className={classNames(projectcss.all, sty.freeBox___2P0Dz)}>
        <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox__x0MfX)}>
          {p.renderPlasmicSlot({
            defaultContents:
        ...
        <div className={classNames(projectcss.all, sty.freeBox___5CnT)}>
          {p.renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.freeBox___7E3Q2)}>
          <div className={classNames(projectcss.all, sty.freeBox__pfQpo)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__p9Auc)}
          ...
          <div className={classNames(projectcss.all, sty.freeBox__lCeKl)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img___9OuCp)}
                    displayHeight={"60px" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"100%" as const}
                    displayMinHeight={"0" as const}
